...
const Counter = () => {
  ...
  const handleClick3 = () => {
    dispatch(CounterActions.doubleincrement({ num: 2 }));
  };

  const handleClick4 = () => {
    dispatch(CounterActions.tenincrement());
  };

  const handleClick5 = () => {
    dispatch(CounterActions.tendecrement({ num: 10 }));
  };
  ...
  return (
    <div>
      ...
      <button onClick={handleClick5}>-10증가</button>
    </div>
  );
};
